export const jobs = [
  {
    id: 'ux-designer',           // ✅ URL becomes /careers/ux-designer
    title: 'UX Designer',
    type: 'Contract',
  ...
  {
    id: 'data-scientist',        // ✅ URL becomes /careers/data-scientist
  ...
  {
    id: 'product-manager',       // ✅ URL becomes /careers/product-manager
  ...
  {
    id: 'open-application',      // ✅ URL becomes /careers/open-application
    title: 'Open Application',
    type: 'Full-time',
    location: 'Denver, CO',
    team: 'General',
    description: "Don't see your role? Apply for an open application!",
