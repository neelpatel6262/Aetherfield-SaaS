...
export const articles = [
  {
    ...
    author: 'Luna Teme',
    image: ArticleOne,
    desc: 'Climate action is only as strong as the data that informs it. But most data stacks werent designed with emissions, supply chains, or climate modelling in mind. Teams are often stuck retrofitting existing systems or relying on brittle workarounds to generate insights. Its time to rethink our infrastructure—starting with the foundation.',
    content: [
      {
