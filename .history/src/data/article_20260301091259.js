import ArticleOne   from '../assets/images/ArticleOne.jpg'   // ✅ imported
...
export const articles = [
  ...
  },
  {
    ...
    content: [
      { heading: 'The Side Project Trap',    body: "Too many sustainability efforts live in a separate lane—disconnected from procurement decisions, product planning, and financial targets. When impact goals aren't embedded in core operations, they stay aspirational. Strategy without systems doesn't scale." },
      { heading: 'Operationalizing Intent',  body: 'Making sustainability operational means assigning ownership, setting measurable milestones, and connecting environmental KPIs to business outcomes. It requires the same rigor applied to revenue targets or customer satisfaction scores.' },
    ],
  },
  {
    id: 3,
    ...
    content: [
      { heading: 'Why We Built It This Way', body: 'Aetherfield was designed around a simple belief: sustainability data should be as usable as financial data. That meant rethinking how emissions, energy, and waste signals are ingested, normalized, and surfaced to decision-makers.' },
    ],
  },
  {
    id: 4,
    ...
    content: [
      { heading: 'The Spreadsheet Era', body: 'For years, sustainability reporting meant exporting data into spreadsheets, manually reconciling figures, and hoping nothing broke before the deadline. It worked—until reporting requirements grew faster than the tools could handle.' },
    ],
  },
  {
    id: 5,
    ...
    content: [
      { heading: 'Myth: Scope 3 Is Optional', body: "Many organizations treat Scope 3 as a future problem. But with regulatory pressure mounting and supply chain scrutiny increasing, upstream and downstream emissions are no longer optional to measure—they're essential to disclose." },
    ],
  },
  {
    id: 6,
    ...
    content: [
      { heading: 'What a Feedback Loop Actually Does', body: 'A feedback loop is not just a dashboard. It is a system that connects measurement to decision-making in near real time. For sustainability, this means building pipelines that surface anomalies, flag goal drift, and recommend adjustments before targets are missed.' },
    ],
  },
]