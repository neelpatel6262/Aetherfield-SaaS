    ...
    <div className="min-h-screen bg-gradient-to-br from-cyan-100 via-blue-50 to-amber-50/30">
      ...
      <section className="relative min-h-[80vh] lg:min-h-screen flex items-center">
        <div className="grid lg:grid-cols-2 w-full h-full">
          ...
          {/* Right mission text – fade + slide from right */}
          <motion.div
        ...
        >
          ...
          <Link to="/careers">
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              transition={{ type: "spring", stiffness: 300 }}
              className="bg-black text-white px-12 py-6 text-xl font-medium hover:bg-gray-900 transition"
            >
              View open roles
            </motion.button>
          </Link>
