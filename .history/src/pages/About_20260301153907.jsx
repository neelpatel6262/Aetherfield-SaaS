...
<section className="py-24 px-6 lg:px-12 bg-gradient-to-r from-blue-50 to-cyan-50">
  <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
    ...
    {/* Right — image + sticker overlay */}
    <div className="order-1 lg:order-2 relative">               {/* ✅ relative parent */}

      {/* Sticker — top left corner overlapping image */}
      <img
        src={StickerPng}
        alt="Aetherfield Sticker"
        className="absolute top-0 left-0 z-10 w-36 md:w-44"    // ✅ absolute top-left
      />
