  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="w-container max-w-container mx-auto px-5 py-20">
        ...
        <p className="text-[16px] text-gray-500 mb-16 max-w-xl font-[subheading]">
        ...
        <div className="flex flex-col gap-4">
          {jobs.map(job => (
            <Link
              key={job.id}
              to={`/careers/${job.id}`}     // ✅ /careers/ux-designer etc
              className="flex justify-between items-center p-6 border border-gray-100 rounded-xl hover:shadow-md transition"
