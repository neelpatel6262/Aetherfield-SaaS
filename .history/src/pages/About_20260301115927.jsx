...
import AboutSectionImg from '../assets/images/AboutSection.jpg';   // Mission left image
import FounderImg from '../assets/images/Founder.jpg';             // Founder portrait (now left)
import StickerContainer from '../assets/images/Sticker container.png'; // Sticker on top of founder
...
export default function About() {
  return (
    ...
    {/* Founder Story - Founder image LEFT + Sticker on LEFT side, black color */}
<section className="py-24 px-6 lg:px-12 bg-gradient-to-r from-blue-50 to-cyan-50">
  <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
    {/* Left: Founder image with sticker on top-left */}
    <div className="relative order-1 lg:order-1">
      <div className="rounded-3xl overflow-hidden shadow-2xl border-8 border-white relative">
        ...
        {/* Sticker container.png – positioned LEFT side, fixed 298px width, forced black */}
        <img
          src={StickerContainer}
          alt="Sticker decoration"
          className="absolute -top-16 -left-16 w-[298px] h-auto object-contain z-20 drop-shadow-2xl"
          style={{
            filter: 'brightness(0) saturate(100%)', // makes any color → pure black
          }}
        />
      </div>
    </div>

    {/* Right: Founder's story text */}
