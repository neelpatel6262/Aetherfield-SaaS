    ...
    >
      <div className="mx-auto px-5 py-12" style={{ maxWidth: '820px' }}>
        ...
        <div className="bg-white rounded-2xl px-8 py-8 flex flex-col gap-8">
          ...
          {/* Header — title + apply btn */}
          <div className="flex items-start justify-between gap-6">
            <div className="flex flex-col gap-2">
              <h1 className="text-[20px] font-bold text-black font-[heading]">
                {job.title}
              </h1>
              <p
            ...
            <button
              className="bg-black text-white px-5 py-2.5 rounded-md hover:opacity-75 transition flex-shrink-0"
          ...
          {/* Short desc */}
          <p className="text-[16px] text-gray-500 leading-relaxed font-[subheading]">
            {job.description}
          </p>
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="text-[14px] text-gray-500 font-[subheading] leading-relaxed">
          ...
          <div className="flex flex-col gap-3">
            ...
            <ul className="flex flex-col gap-2">
              {job.requirements.map((req, i) => (
                <li
                  key={i}
                  className="flex items-start gap-2 text-[14px] text-gray-500 font-[subheading]"
                >
          ...
          <div className="flex flex-col gap-3">
            ...
            {/* Benefits list + sticker side by side */}
