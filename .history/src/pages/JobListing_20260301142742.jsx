...
const JobListing = () => {
  ...
  if (!job) return (
    <div className="w-container max-w-container mx-auto px-5 py-32 text-center">
      ...
      <Link to="/careers" className="text-[14px] text-black underline font-[btn]">
        ← See all roles
      </Link>
    </div>
  )
  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="w-container max-w-container mx-auto px-5 py-20">
        ...
        {/* Back */}
        <Link to="/careers" className="text-[14px] text-gray-400 hover:text-black transition font-[btn]">
          ← Back to Careers
        </Link>
        ...
        <div className="mt-8 mb-10 border-b border-gray-100 pb-10">
          ...
          <h1 className="text-[40px] font-extrabold text-black mb-2 font-[heading]">{job.title}</h1>
          <p className="text-[14px] text-gray-400 font-[btn]">{job.location}</p>
        </div>

        {/* Body */}
        <div className="max-w-2xl">
          <h2 className="text-[24px] font-bold text-black mb-4 font-[heading]">About this role</h2>
