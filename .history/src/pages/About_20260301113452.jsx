...
import ValuesBG from '../assets/images/Values section.jpg';

import { PieChart, Globe, ArrowUpRight } from 'lucide-react';

// ... (values and teamMembers arrays remain the same as before)
...
export default function About() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-100 via-blue-50 to-amber-50/30">
      ...
      {/* Hiring CTA - now links to /careers */}
      <section className="py-24 px-6 lg:px-12 text-center bg-gradient-to-b from-cyan-50 to-white">
        <div className="max-w-4xl mx-auto">
          ...
          {/* This button now navigates to Careers page */}
          <Link
            to="/careers"
            className="inline-block bg-black text-white px-12 py-6 text-xl font-medium hover:bg-gray-900 transition"
          >
            View open roles
          </Link>
        </div>
