...
import AboutImage from '../assets/images/About.jpg';           // used in mission section
import FounderImg from '../assets/images/Founder.jpg';         // founder portrait
import ValuesBG from '../assets/images/Values section.jpg';    // values background
...
export default function About() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-100 via-blue-50 to-amber-50/30">
      {/* Mission Section - left side text, background image */}
      <section className="relative min-h-[70vh] flex items-center px-6 lg:px-12 py-16 lg:py-24">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <p className="text-xl md:text-2xl lg:text-3xl text-gray-100 leading-relaxed max-w-2xl">
          ...
          <div className="mt-10 flex flex-wrap gap-6">
            <button className="bg-black text-white px-8 py-4 text-lg font-medium hover:bg-gray-900 transition">
              Meet the team
            </button>
          </div>
        </div>
