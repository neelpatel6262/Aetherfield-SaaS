  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="w-container max-w-container mx-auto px-5 py-16">
        ...
        <h2
          className="text-3xl font-bold text-black text-center mb-12 font-[heading]"
        >
          Latest articles
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {articles.map(article => (
            <Link
              ...
              className="flex flex-col gap-3 group no-underline max-w-full"
            >
              ...
              {/* Title */}
              <p className="text-base font-semibold text-black leading-snug mt-2 font-[heading]">
                {article.title}
              </p>

              {/* Meta */}
              <p className="text-xs text-gray-400 font-[btn]">
                {article.category} · {article.time}
              </p>

              {/* Description */}
              <p className="text-sm text-gray-500 leading-relaxed font-[subheading]">
                {article.desc}
              </p>
