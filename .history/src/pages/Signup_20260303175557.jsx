...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Simulate API delay (replace with real fetch/axios later)
      ...
      const userData = {
        ...
        password: form.password, // In real app → NEVER store plain text!
      ...
      <div className="relative">
        ...
        <button
          ...
          onClick={(e) => {
            ...
            e.stopPropagation();      // ← STOPS click bubbling to input → fixes typing lag
            onToggle();
          }}
