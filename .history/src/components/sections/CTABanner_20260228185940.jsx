...
const CTABanner = () => {
  return (
    <section className="w-full bg-white py-20 md:py-24">
      <div className="w-full max-w-[1280px] mx-auto px-6 md:px-8 lg:px-10 bg-gray-100 py-20 md:py-28">
        <div className="flex flex-col items-center gap-6 max-w-2xl mx-auto text-center">
          <h2
            className="text-8xl md:text-6xl font-extrabold text-black leading-tight tracking-tight w-full "
