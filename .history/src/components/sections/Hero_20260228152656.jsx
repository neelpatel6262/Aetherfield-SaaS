...
const Hero = () => {
  return (
    ...
    >
      ...
      <h1
        className="text-5xl md:text-6xl font-extrabold text-center text-black leading-tight max-w-2xl font-[Heading]"
        style={{ fontFamily: 'Radio Canada Big', fontWeight: 'bold' }}
      >
        Sustainability insights
      </h1>

      <h1 className="text-5xl md:text-6xl font-extrabold text-center text-black leading-tight max-w-2xl font-[Subheading]">
        built for business
      </h1>

  
      <p
        className="mt-5 text-base text-center text-black/60 max-w-lg leading-relaxed w-full "
        style={{ fontFamily: 'Source Serif Pro', fontWeight: 'normal' }}
      >
