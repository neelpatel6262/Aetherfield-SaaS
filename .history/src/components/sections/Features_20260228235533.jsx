          ...
          <div className="relative w-full md:w-1/2">
            ...
            <div className="absolute bottom-5 left-5 right-5 bg-white rounded-xl shadow-md px-5 py-4">
              <div className="flex justify-between items-center mb-6">
                <p className="text-[12px] text-gray-400 font-[btn]">Energy consumption</p>
                <span className="text-gray-300 text-xl">✳</span>
              </div>
              <div className="flex justify-between items-end">
                <p className="text-[30px] font-extrabold text-black font-[heading]">
                  583.7
                  <span className="text-[14px] font-normal text-gray-400 ml-1">MWh</span>
                </p>
                <p className="text-[14px] font-semibold text-blue-500 font-[btn]">+12.4%</p>
              </div>
            </div>
          </div>
