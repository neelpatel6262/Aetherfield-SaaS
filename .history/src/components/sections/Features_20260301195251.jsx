  ...
  return (
    <section className="w-full bg-white py-20">
      <div className="w-container max-w-container mx-auto px-5">
        ...
        <h2 className="text-[40px] font-extrabold text-center text-black leading-snug mb-16 font-[subheading] leading-tight">
            ...
            {features.map((f, i) => (
              <div key={f.number} className={`flex justify-between items-start py-5 ${i !== features.length - 1 ? 'border-b border-gray-200' : ''}`}>
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[16x] text-gray-500 font-[subheading]">{f.desc}</p>
                </div>
