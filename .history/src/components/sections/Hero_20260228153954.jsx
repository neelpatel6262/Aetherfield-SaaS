  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center mt-10 mb-0">
        <h1
          className="text-6xl md:text-7xl font-extrabold text-center text-black leading-none tracking-tight"
        ...
        <h1
          className="text-6xl md:text-7xl font-extrabold text-center text-black leading-none tracking-tight"
          style={{ fontFamily: 'subheading, serif' }}
        >
          built for business
        </h1>
      </div>
      ...
      <p
        className="mt-6 text-sm md:text-base text-center text-black/50 max-w-md leading-relaxed font-[subheading, sans-serif]"
