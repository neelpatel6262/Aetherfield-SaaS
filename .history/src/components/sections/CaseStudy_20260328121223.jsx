...
function CaseStudy() {
  ...
  const textAnim  = useScrollAnimation({ duration: 0.7, delay: 0.2 })
      ...
      <div className="mx-auto w-full max-w-7xl px-5 md:px-6 lg:px-8">
        ...
        >
          <div className="flex flex-col md:flex-row">
            ...
            <motion.div {...imgAnim} className="relative w-full md:w-1/2">
              <img
            ...
            <motion.div {...textAnim} className="flex w-full flex-col justify-center gap-6 px-8 py-12 md:w-1/2 md:px-12 lg:px-16">
              ...
              <motion.button
                ...
                className="self-start bg-black px-7 py-3 text-sm font-semibold text-white transition hover:bg-black/90 active:opacity-80"
              >
                Read case study →
              </motion.button>
            </motion.div>
