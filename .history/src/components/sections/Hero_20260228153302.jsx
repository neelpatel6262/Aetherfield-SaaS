...
const Hero = () => {
  return (
    ...
    >
      ...
      {/* h1 — uses 'heading' alias = Source Serif 4 */}
      <h1
      ...
      {/* h1 — uses 'subheading' alias = Radio Canada Big */}
      <h1
        className="text-5xl md:text-6xl font-extrabold text-center text-black leading-tight max-w-2xl"
      ...
      {/* p — inherits 'subheading' from Home div, no override needed */}
      <p className="mt-5 text-base text-center text-black/60 max-w-lg leading-relaxed w-full">
        Track impact, reduce emissions, and accelerate progress—with clarity and confidence.
      </p>

      {/* Buttons — uses 'btn' alias = Geist Mono (already set globally in index.css) */}
