  ...
  return (
    <section className="w-full bg-white py-20 md:py-24">
      <div className="w-full max-w-[1440px] mx-auto px-6 md:px-8 lg:px-10">
        ...
        <h2
          className="text-3xl md:text-4xl font-extrabold text-center text-black leading-snug mb-12 md:mb-16 font-[heading,serif]"
        >
          Everything you need to measure,<br />
          model, and act on sustainability
        </h2>

        <div className="flex flex-col md:flex-row gap-10 md:gap-12 items-stretch max-w-5xl mx-auto">
