...
### Key fix — why bg stays on top when scrolling:
```
❌ Before — nav was sticky with bg
   <nav className="sticky top-0 bg-white/80">

✅ After — wrapper div is sticky with bg
   <div className="sticky top-0 z-50 bg-white/80">
     <nav>...</nav>
     {open && <mobile menu>}   ← dropdown is INSIDE sticky div
   </div>

Result: bg + dropdown both stick together,
        never overlaps sections below