...
function Footer() {
  return (
    <footer className="w-full bg-[#FFF546] text-[#66640F] flex flex-col items-center overflow-hidden bg-cover bg-center">
      <div className="w-full max-w-[1280px] px-5 py-5 md:py-8 lg:py-10 flex flex-col items-center">
