...
function Footer() {
  return (
    <footer className="w-full bg-[#FFFF00] text-black relative overflow-hidden">
      {/* Background texture image – covers most of the footer (wavy/fabric/grainy style) */}
      <div 
        className="absolute inset-0 bg-cover bg-center opacity-90"
        style={{
          backgroundImage: `url('/src/assets/images/Footer image.jpg')`, // ← your file name
          // OR if it's in public/assets/ → url('/assets/Footer image.jpg')
        }}
      />

      {/* Content layer – on top of the texture */}
      <div className="relative z-10 px-6 py-12 md:py-16 flex flex-col items-center">
        {/* Top repeated nav links – same as mockup */}
        ...
        {/* Big brand text at the bottom – text only, very large */}
        ...
        {/* Extra bottom padding so the big text doesn't touch the edge */}
