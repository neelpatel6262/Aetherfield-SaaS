...
import useScrollAnimation from '@/hooks/useScrollAnimation'; // ← using the hook
...
function Footer() {
  ...
  // Animation for individual links (with stagger via delay)
  const linkAnim = useScrollAnimation({
    duration: 0.5,
    y: 15,
  });

  // Texture animation (slightly delayed)
  ...
  // Logo animation (more delayed for layered feel)
