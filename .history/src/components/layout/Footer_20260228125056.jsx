...
import footerimag from '../../assets/images/footerimag.jpg';
...
<div>
  <img src={footerimag} alt="Footer Image" className="w-full h-auto object-cover" />
</div>
<div>
  <img src={Logo} alt="Logo" className="w-auto h-10 mx-auto" />
</div>
    </footer>
  );
}
