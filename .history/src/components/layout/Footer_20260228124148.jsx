...
function Footer() {
  return (
    <footer className="w-full bg-[#FFF546] text-[#66640F] relative overflow-hidden">
     <div>
      <ul className="flex flex-wrap justify-center gap-x-6 md:gap-x-10 gap-y-3 text-sm md:text-base font-semibold uppercase tracking-wide mb-10 md:mb-12 font-[heading]">
          {links.map((link) => (
            <li key={link.to}>
              <Link
                to={link.to}
