    ...
    <footer className="w-full bg-[#FFF546] text-[#66640F] relative overflow-hidden">
      <div className="relative z-10 px-6 py-12 md:py-16 flex flex-col items-center">
        ...
        <img
          ...
          className="w-auto h-10 md:h-12 mb-10 md:mb-16 text-6xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-[10rem] font-black uppercase tracking-tighter leading-none text-center opacity-90"
        />
