...
const NotFound = () => (
  <div className="w-full min-h-screen bg-[#E8E8E8] flex flex-col items-center justify-center gap-6 px-4">
    ...
    {/* 4 ✳ 4 — scales down on mobile */}
    <div className="flex items-center leading-none">
      <span
        className="font-extrabold text-black"
        style={{
          fontFamily: 'heading, serif',
          fontSize: 'clamp(120px, 20vw, 380px)',  // ✅ fluid — 120px mobile → 380px desktop
          lineHeight: 1,
        }}
      >
        4
      ...
      <span
        ...
        style={{
          fontFamily: 'heading, serif',
          fontSize: 'clamp(90px, 15vw, 300px)',   // ✅ fluid — 90px mobile → 300px desktop
          lineHeight: 1,
        }}
      >
        ✳
      ...
      <span
        ...
        style={{
          fontFamily: 'heading, serif',
          fontSize: 'clamp(120px, 20vw, 380px)',  // ✅ fluid
          lineHeight: 1,
        }}
      >
        4
