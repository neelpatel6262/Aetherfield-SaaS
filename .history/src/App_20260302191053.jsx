...
// 404 Page (used for unmatched routes)
const NotFound = () => (
...
const App = () => {
  return (
    <BrowserRouter>
      ...
      <Routes>
        {/* Pages WITH Navbar + Footer (using Layout) */}
        <Route element={<Layout />}>
          ...
          <Route path="/product"        element={<Home />} /> {/* or your real Product page */}
        </Route>

        {/* Pages WITHOUT Navbar + Footer */}
        <Route path="*" element={<NotFound />} /> {/* 404 for any unmatched route */}
      </Routes>
    </BrowserRouter>
  );
};
